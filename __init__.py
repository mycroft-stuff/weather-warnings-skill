...
class WeatherWarnings(MycroftSkill):
    ...
    def handle_warnings_weather(self, message):
        ...
        lookup_aemet = "lynx -dump https://www.meteoblue.com/en/weather/warnings/gandesa_spain_3121642 | grep -A5000 -m1 -e 'explanations:' | grep -vE 'explanations:|^--' | grep -m1 -B 999 -- "Instructions:" | tail -n +2"
